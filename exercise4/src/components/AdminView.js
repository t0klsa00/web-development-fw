...
export default function AdminView(props) {
  ...
  const addNewItem = () => {
    props.addNewItem(newItemName, newItemmanufacturer, newItemPrice, newItemRating, newItemImage);
  }
  ...
  return (
    <div>
      <div>
          ...
          <div>
            Image <input type="text" onChange={ (event) => setNewItemImage(event.target.value) } /> Images are located to ./public/images. You can add new images in that folder. You can use image by typing its name like: 'example.png'. </div>

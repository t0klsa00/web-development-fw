...
class AdminView extends React.Component {
  ...
  addNewItem = () => {
    this.props.addNewItem(this.state.newItemName, this.state.newItemmanufacturer, this.state.newItemPrice, this.state.newItemRating, this.state.newItemImage);
  }
    ...
    return (
      <div>
        <div>
            ...
            <div>
              Image <input type="text" onChange={ (event) => this.setState({ newItemImage: event.target.value }) } />
            </div>
